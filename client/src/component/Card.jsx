            ...
            <div class=" p-4">
                <div class="bg-white border rounded-sm max-w-md">
                    <div class="flex items-center px-4 py-3">
                        <img class="h-8 w-8 rounded-full" src={post.postedBy ? post.postedBy.Photo:  "https://picsum.photos/id/1027/150/150"} />
                        <div class="ml-3 ">
                            <span class="text-sm font-semibold antialiased block leading-tight">{post.postedBy && post.postedBy.name}</span>
                            {/* <span class="text-gray-600 text-xs block">Asheville, North Carolina</span> */}
                        </div>
                    </div>
                    <img src={post ? post.photo : "https://picsum.photos/id/244/900/900" } className='h-[25.5rem] w-[370px]'/>
                    ...
                    <div class="font-semibold text-sm mx-4 mt-2 mb-4">{post && post.likes && post.likes.length>0 ? post.likes.length : '20'}</div>
                </div>
            </div>
        </div>
    )
