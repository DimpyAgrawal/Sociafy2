    ...
    <>
      <main className="w-full flex">
            <div className="relative flex-1 hidden items-center justify-center h-screen bg-gray-900 lg:flex">
                ...
                <span className="self-center text-2xl font-semibold whitespace-nowrap text-white">SOCIAFY</span>
            ...
            <div className="flex-1 flex items-center justify-center h-screen">
                    ...
                    <div className="">
                        ...
                        <div className="mt-5 space-y-2">
                            ...
                            <p className="">Already have an account?
                             <Link to="/signin" className="font-medium text-indigo-600 hover:text-indigo-500">Log in</Link></p>
                        </div>
                    </div>
                    <div className="grid grid-cols-3 gap-x-3" onClick={()=>notify2('Under Maintance..')}>
              ...
              <input type="text" className="w-full mt-2 px-3 py-2 text-gray-500 bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg" name="name" placeholder='Name' value={name} onChange={(e) => onValueChange(e)} /><br />
              </div>
                        <div>
                            <label className="font-medium">
                                Email
                            </label>
              <input type="email"  className="w-full mt-2 px-3 py-2 text-gray-500 bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg" id="email" name="email" placeholder='Email Address' value={email} onChange={(e) => onValueChange(e)} /><br />
              </div>
                        <div>
                            <label className="font-medium">
                                Password
                            </label>
              <input type="password"   className="w-full mt-2 px-3 py-2 text-gray-500 bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg" id="password" name="password" placeholder='Password' value={password} onChange={(e) => onValueChange(e)} /><br />
              </div>
              <button   className="w-full px-4 py-2 text-white font-medium bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-600 rounded-lg duration-150" onClick={(e) => handleSubmit(e)}> Create account</button>
              </div>
                </div>
            </div>
        </main>
